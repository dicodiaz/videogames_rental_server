...
RSpec.describe '/videogames', type: :request do
  ...
  # VideogamesController, or in your router and rack
  ...
  describe 'GET /index' do
    it 'renders a successful response' do
      ...
      get videogames_url, headers: valid_headers, as: :json
  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      it 'creates a new Videogame' do
        expect do
          post videogames_url,
               params: { videogame: valid_attributes }, headers: valid_headers, as: :json
    ...
    context 'with invalid parameters' do
      it 'does not create a new Videogame' do
        expect do
          post videogames_url,
               params: { videogame: invalid_attributes }, as: :json
        end.to change(Videogame, :count).by(0)
      end

      it 'renders a JSON response with errors for the new videogame' do
        post videogames_url,
             params: { videogame: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe 'PATCH /update' do
    context 'with valid parameters' do
      ...
      it 'updates the requested videogame' do
        videogame = Videogame.create! valid_attributes
        patch videogame_url(videogame),
              params: { videogame: new_attributes }, headers: valid_headers, as: :json
        videogame.reload
